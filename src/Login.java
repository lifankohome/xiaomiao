...
public class Login extends JFrame {
    ...
    public static String config = Config.read("D:\\config.ini");
    ...
    public Login() {
            ...
            public void mouseClicked(MouseEvent arg0) {
                ...
                if (result.substring(0, 4).equals("登录成功")) {
                    ...
                    if (!loginDirect) {
                        ...
                        Config.save("D:\\config.ini", stuId.getText() + pass + ". By lifanko.");
                    }
                } else {
                    Config.save("D:\\config.ini", stuId.getText());
                }
            }
        });
        panel.add(btnLogin);
        ...
        tip.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent arg0) {
                openURL("http://eeec.hpu.edu.cn/idp/");
            }
        });
